import{X as T,d as i,j as e,R as z,S as L,e as S,A as M}from"./ContextMenuProvider-BnbZ3Xw_.js";import{L as $}from"./index-BnBVZe7Y.js";import{B as A}from"./BreadCrumb-Bcutq_zH.js";import{Q as O}from"./react-toastify.esm-Dj3bmGVf.js";import{s as o}from"./showToast-CDGTjd8l.js";import{C as X}from"./CKEditorContent-DPMihEou.js";import{ModalCheckoutPlan as K}from"./ModalCheckoutPlan-CiAY7eZE.js";import{ModalSelectPaymentMethod as Q}from"./ModalSelectPaymentMethod-C3w8UOUu.js";import{ModalPurchaseResult as V}from"./ModalPurchaseResult-RAh6J535.js";import{h as f}from"./moment-C5S46NFB.js";import{u as q}from"./useTranslation-CtwHyjpC.js";import{C as G}from"./Container-xmF8fBYZ.js";import{R as j}from"./Row-D4DhAVVB.js";import{C as l}from"./Col-DMyGedr-.js";import{C as p}from"./Card-bUFuojd-.js";import{B as J}from"./Button-BRcUTJGP.js";import"./index-DJrr_1Uz.js";import"./RightSidebar-BlNIcKur.js";import"./thunk-BdeJSdvk.js";/* empty css                      */import"./LightDark-DNWszmZt.js";import"./isSymbol-CYvIzdD2.js";import"./ThemeProvider-C0xt9VP8.js";import"./reselect-CiXCCDx7.js";import"./useIsomorphicEffect-CgDepx_Y.js";import"./useWindow-ByxVeiaK.js";import"./useMergedRefs-0e-0eNkH.js";import"./useEventCallback-BuAGpOO_.js";import"./useEventCallback-CWLYZk1t.js";import"./AbstractModalHeader-DeFu7Xk5.js";import"./querySelectorAll-6mKGZXEM.js";import"./hasClass-D5mdPDLg.js";import"./NoopTransition-Ck7A0kGI.js";import"./TransitionWrapper-DdJIchS_.js";import"./objectWithoutPropertiesLoose-Dsqj8S3w.js";import"./setPrototypeOf-DgZC2w_0.js";import"./DataKey-DjdvojM5.js";import"./CloseButton-Be0iGRvt.js";import"./Fade-DiSce4YX.js";import"./divWithClassName-Egl5q-Z9.js";import"./Collapse-DMC4Mlvv.js";import"./Form-kohAgaPo.js";import"./logo-dark-CCAAFdaA.js";import"./logo-light-D3OEWz0M.js";import"./LanguageDropdown-BKUk_KR5.js";import"./Dropdown-5Gi4Yv0j.js";import"./SSRProvider-deIbZZYa.js";import"./SelectableContext-DwW_dd8V.js";import"./NavbarContext-DjQnybmt.js";import"./Button-C_zChQbi.js";import"./hook-UG-9p7bs.js";import"./extends-CF3RwP-h.js";import"./Anchor-Dx9niwmc.js";import"./InputGroupContext-CJ4MYKQG.js";import"./user-dummy-img-BMkyJzBF.js";import"./Badge-DlJ31L09.js";import"./avatar-1-PHP4S1R6.js";/* empty css                  */import"./Modal-mwm3tf-U.js";import"./useWillUnmount-JMQ9EYbt.js";import"./Alert-Dk6PjGHg.js";const W=()=>{const{t:s}=q(),{plans:x,paymentMethods:c,currentUserPlan:t}=T().props,[C,d]=i.useState(!1),[_,h]=i.useState(!1),[k,g]=i.useState(!1),[y,u]=i.useState(null),[D,v]=i.useState(null),[w,N]=i.useState(null),m=i.useRef(null),R=async()=>{try{const a=route("seller.plan.ping"),r=await S.get(a);r.data.status==="success"&&(m.current&&(clearInterval(m.current),m.current=null),h(!1),d(!1),u(null),v(r.data.data),g(!0))}catch(a){console.error("Error pinging purchase status:",a)}};i.useEffect(()=>(m.current=setInterval(()=>{R()},3e3),()=>{m.current&&clearInterval(m.current)}),[]);const P=async a=>{if(!a){o(s("Invalid plan selected"),"error");return}if(!c||(c==null?void 0:c.length)===0){o(s("No payment methods available. Please contact support"),"error");return}N(a),M.reload({only:["paymentMethods"],onSuccess:()=>{d(!0),u(null)},onError:()=>{o(s("Failed to load payment methods"),"error")}})},Y=async a=>{if(!w){o(s("No plan selected"),"error");return}const r=c.find(n=>n.id===a);if(!r||!(r!=null&&r.id)){o(s("No valid payment method found. Please contact support"),"error");return}const b=route("seller.plan.checkout");await S.post(b,{plan_id:w,payment_method_id:r.id}).then(n=>{n.data.status==="success"?(u(n.data.data),d(!1),h(!0)):o(s(n.data.message),"error")}).catch(n=>{o(s(n.response.data.message),"error")})},B=()=>{d(!1),N(null)},E=()=>{h(!1),u(null),N(null)},F=()=>{g(!1),v(null)},I=()=>{g(!1),y?h(!0):d(!0)},H=()=>{h(!1),u(null),M.reload({only:["paymentMethods"],onSuccess:()=>{d(!0)},onError:()=>{o(s("Failed to load payment methods"),"error")}})};return e.jsxs(z.Fragment,{children:[e.jsx(L,{title:s("Subscription Plans")}),e.jsx("style",{children:`
          .pricing-box {
