                            ...
                            <div className="col-md-8 col-lg-6 col-xl-5">
                                <div className="card mt-4">
                                    <div className="card-body p-4 text-center">
                                        ...
                                        <p className="text-muted mb-4">Chúc mừng! Cửa hàng của bạn đã được tạo.</p>

                                        <p className="mb-4">Đang chuyển hướng trong <span className="fw-semibold">{counter}s</span>...</p>

                                        <div className="d-flex gap-2 justify-content-center">
                                            <a className="btn btn-success" href={redirectUrl}>Vào trang quản trị ngay</a>
                                            <Link className="btn btn-outline-secondary" href="/">Về trang chủ</Link>
                                        </div>
                                    </div>
                                </div>
                            </div>
