...
const SalesForecastCharts = ({ chartId, series } : any) => {
    var areachartSalesColors = useChartColors(chartId);
    ...
    return (
        <React.Fragment>
            <ReactApexChart dir="ltr"
                ...
                data-colors-minimal='["--vz-primary-rgb, 0.15", "--vz-primary-rgb, 0.35", "--vz-primary-rgb, 0.45"]' data-colors-modern='["--vz-warning", "--vz-secondary", "--vz-success"]' 
