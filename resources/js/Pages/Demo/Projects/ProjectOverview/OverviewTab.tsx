                    ...
                    <Card>
                        <Card.Body>
                            <div className="text-muted">
                                ...
                                <div>
                                    <button type="button" className="btn btn-link link-success p-0 material-shadow">Read more</button>
                                </div>
                                                ...
                                                <div className="d-flex align-items-center">
                                                    ...
                                                    <div className="flex-shrink-0 ms-2">
                                                        <div className="d-flex gap-1">
                                                            ...
                                                            <Dropdown>
                                                                <Dropdown.Toggle as="button" className="btn btn-icon text-muted btn-sm fs-18 dropdown arrow-none material-shadow-none">
                                                                    <i className="ri-more-fill"></i>
                                                                </Dropdown.Toggle>
                                                                <Dropdown.Menu>
                                                                    <li><Dropdown.Item><i className="ri-pencil-fill align-bottom me-2 text-muted"></i> Rename</Dropdown.Item></li>
                                    ...
                                    <div className="d-flex align-items-center">
                                        ...
                                        <div className="flex-shrink-0">
                                            <div className="d-flex align-items-center gap-1">
                                                ...
                                                <Dropdown>
                                                    <Dropdown.Toggle type="button" className="arrow-none btn btn-icon btn-sm fs-16 text-muted dropdown material-shadow-none" as="button">
                                                        <i className="ri-more-fill"></i>
                                                    </Dropdown.Toggle>
                                                    <Dropdown.Menu>
                                    ...
                                    <div className="d-flex align-items-center">
                                        ...
                                        <div className="flex-shrink-0">
                                            <div className="d-flex align-items-center gap-1">
                                                <button type="button" className="btn btn-light btn-sm material-shadow-none">Message</button>
                                                <Dropdown>
                                                    <Dropdown.Toggle as="button" className="arrow-none btn btn-icon btn-sm fs-16 text-muted dropdown material-shadow-none">
                                                        <i className="ri-more-fill"></i>
                                                    </Dropdown.Toggle>
                                                    <Dropdown.Menu>
                                                        <li><Dropdown.Item><i className="ri-eye-fill text-muted me-2 align-bottom"></i>View</Dropdown.Item></li>
                                    ...
                                    <div className="d-flex align-items-center">
                                        ...
                                        <div className="flex-shrink-0 ms-2">
                                            <div className="d-flex gap-1">
                                                <button type="button" className="btn btn-icon text-muted btn-sm fs-18 material-shadow-none"><i className="ri-download-2-line"></i></button>
                                                <Dropdown>
                                                    <Dropdown.Toggle as="button" className="arrow-none btn btn-icon text-muted btn-sm fs-18 dropdown material-shadow-none" type="button">
                                                        <i className="ri-more-fill"></i>
                                                    </Dropdown.Toggle>
                                                    <Dropdown.Menu>
                                                        <li><Dropdown.Item><i className="ri-pencil-fill align-bottom me-2 text-muted"></i> Rename</Dropdown.Item></li>
