                                            ...
                                            <div className="d-flex">
                                                ...
                                                <div className="flex-shrink-0">
                                                    <div className="d-flex gap-1 align-items-center">
                                                        <button type="button" className={`btn avatar-xs mt-n1 p-0 material-shadow-none favourite-btn ${item.ratingClass}`} onClick={(e) => activebtn(e.target)}>
                                                            <span className="avatar-title bg-transparent fs-15">
                                                                <i className="ri-star-fill"></i>
                                                            </span>
                                                        </button>
                                                        <Dropdown dir='start'>
                                                            <Dropdown.Toggle as="button" className="btn btn-link text-muted p-1 mt-n2 py-0 text-decoration-none fs-15 arrow-none material-shadow-none">
                                                ...
                                                <div className="avatar-group">
                                                    {item.subItem.map((item: any, key: any) => (
                                                        <React.Fragment key={key}>
                                                            {item.imgFooter ? <Link href="#" className="avatar-group-item material-shadow" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Darline Williams">
                                                                <div className="avatar-xxs">
                                                                    <img src={item.imgFooter} alt="" className="rounded-circle img-fluid" />
                                                                </div>
                                                            </Link> : <Link href="#" className="avatar-group-item material-shadow" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Add Members">
                                                                <div className="avatar-xxs">
                                            ...
                                            <div className="py-3">
                                                ...
                                                <div className="d-flex align-items-center mt-3">
                                                    ...
                                                    <div className="avatar-group">
                                                        ...
                                                        {item.subItem.map((item: any, key: any) => (
                                                            <React.Fragment key={key}>
                                                                {item.imgTeam ? <Link href="#" className="avatar-group-item material-shadow" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Darline Williams">
                                                                    <div className="avatar-xxs">
                                                                        <img src={item.imgTeam} alt="" className="rounded-circle img-fluid" />
                                                                    </div>
                                                                </Link> : <Link href="#" className="avatar-group-item material-shadow" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Donna Kline">
                                                                    <div className="avatar-xxs">
