                    ...
                    <Card className="card-height-100">
                        <Card.Header className="align-items-center d-flex">
                            ...
                            <div className="flex-shrink-0">
                                <Button variant="primary" size='sm' className="btn-soft-primary material-shadow">
                                    Export Report
                                </Button>
                            </div>
                        </Card.Header>
                ...
                <Col xxl={4} xl={6}>
                    <Card className="card-height-100">
                        <Card.Header className="align-items-center d-flex">
                            ...
                            <div>
                                <Button variant="secondary" size="sm" className="material-shadow-none btn-soft-secondary me-1">
                                    ALL
                                </Button>
                                <Button variant="primary" size="sm" className="material-shadow-none btn-soft-primary me-1">
                                    1M
                                </Button>
                                <Button variant="secondary" size="sm" className="material-shadow-none btn-soft-secondary">
                                    6M
                                </Button>
                            </div>
                        </Card.Header>
                    ...
                    <Card className="card-height-100">
                        <Card.Header className="border-0 align-items-center d-flex">
                            ...
                            <div>
                                ...
                                <Button variant="primary" size="sm" className="material-shadow-none btn-soft-primary">
                                    1Y
                                </Button>
                            </div>
                        </Card.Header>
                ...
                <Col xxl={4} xl={6}>
                    <Card className="card-height-100">
                        <Card.Header className="align-items-center d-flex">
                            ...
                            <div className="flex-shrink-0">
                                <Button variant="primary" size="sm" className="btn-soft-primary material-shadow-none">
                                    Export Report
                                </Button>
                            </div>
                        </Card.Header>
