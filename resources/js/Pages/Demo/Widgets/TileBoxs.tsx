                            ...
                            <Card.Body>
                                ...
                                <div className="d-flex align-items-end justify-content-between mt-4">
                                    ...
                                    <div className="avatar-sm flex-shrink-0">
                                        <span 
                                        className={"avatar-title material-shadow rounded fs-3 bg-" + item.iconClass}
                                        >
                    ...
                    <Card className={"card-animate " + item.bgColor}>
                        <Card.Body>
                            <div className="d-flex justify-content-between">
                                ...
                                <div>
                                    <div className="avatar-sm flex-shrink-0">
                                        <span className={"avatar-title material-shadow rounded-circle fs-2 bg-" + item.iconClass}>
                                            <FeatherIcon
                                                icon={item.feaIcon}
