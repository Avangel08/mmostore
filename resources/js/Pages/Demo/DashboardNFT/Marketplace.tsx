                                    ...
                                    <div className="">
                                        <Card.Header className="border-0 align-items-center d-flex">
                                            ...
                                            <div className='d-flex gap-1'>
                                                <button type="button" className="btn btn-soft-secondary btn-sm material-shadow-none"
                                ...
                                <Col xxl={4}>
                                    <div className="border-start p-4 h-100 d-flex flex-column">
                                        ...
                                        <div className="w-100">
                                            ...
                                            <h3 className="ff-secondary cfs-22 fw-bold mt-4"><i className="mdi mdi-ethereum text-primary"></i> 346.12 ETH</h3>
