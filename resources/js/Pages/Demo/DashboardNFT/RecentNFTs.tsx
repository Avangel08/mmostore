                ...
                <Col xxl={3} lg={6}>
                    <Card>
                        <Card.Header className="d-flex align-items-center">
                            ...
                            <Link href="/apps-nft-collections" type="button" className="btn btn-soft-primary btn-sm flex-shrink-0 material-shadow-none">
                    ...
                    <Card>
                        <Card.Header className="d-flex align-items-center">
                            ...
                            <Link href="/apps-nft-creators" type="button" className="btn btn-soft-primary btn-sm flex-shrink-0 material-shadow-none">
                                See All <i className="ri-arrow-right-line align-bottom"></i>
                            </Link>
                        </Card.Header>
                        <Card.Body>
