            ...
            <div className="border-top border-top-dashed pt-3 mt-3">
              ...
              <div className="mt-2 vstack email-chat-list mx-n4">
                {chatData.map((item, key) => (
                  <a href="#" className="d-flex align-items-center" key={key}>
              ...
              <div className="col-sm order-3 order-sm-2">
                <div className="hstack gap-sm-1 align-items-center flex-wrap email-topbar-link">
                  ...
                  <Dropdown>
                    <Dropdown.Toggle
                      as="button"
                      className="btn btn-ghost-secondary btn-icon btn-sm fs-16 arrow-none material-shadow-none"
                    >
                      <i className="ri-price-tag-3-fill align-bottom"></i>
                    </Dropdown.Toggle>
                    <Dropdown.Menu className="dropdown-menu-end">
                      <Dropdown.Item onClick={() => labeledEmail("support")}>
                        Support
                      </Dropdown.Item>
                      <Dropdown.Item onClick={() => labeledEmail("freelance")}>
                        Freelance
                      </Dropdown.Item>
                      <Dropdown.Item onClick={() => labeledEmail("social")}>
                        Social
                      </Dropdown.Item>
                      <Dropdown.Item onClick={() => labeledEmail("friends")}>
                        Friends
                      </Dropdown.Item>
                      <Dropdown.Item onClick={() => labeledEmail("family")}>
                        Family
                      </Dropdown.Item>
                    </Dropdown.Menu>
                  </Dropdown>
                  ...
                  <Dropdown>
                    ...
                    <Dropdown.Menu className="dropdown-menu-end">
                      <Dropdown.Item onClick={() => readAll("read")}>
                        Mark all as Read
                      </Dropdown.Item>
                    </Dropdown.Menu>
                  </Dropdown>
                  ...
                  filteredMails.map((item: any, key: any) => (
                    ...
                    >
                      ...
                      <div
                        ...
                        onClick={() => sidebarToggle(item)}
                      >
                        <a href="#" className="text-start subject">
                          {" "}
                          {item.badge ? (
                ...
                <div className="bg-light px-2 py-1 rouned-bottom border">
                  <Row>
                    <Col>
                      <OverlayTrigger
                        placement="top"
                        overlay={<Tooltip placement="top">Bold</Tooltip>}
                        rootClose={true}
                      >
                        <Button
                          size="sm"
                      ...
                      <OverlayTrigger
                        placement="top"
                        overlay={<Tooltip placement="top">Italic</Tooltip>}
                        rootClose={true}
                      >
                        <Button
                          size="sm"
                      ...
                      <OverlayTrigger
                        placement="top"
                        overlay={<Tooltip placement="top">Link</Tooltip>}
                        rootClose={true}
                      >
                        <Button
                          size="sm"
                      ...
                      <OverlayTrigger
                        placement="top"
                        overlay={<Tooltip placement="top">Image</Tooltip>}
                        rootClose={true}
                      >
                        <Button
                          size="sm"
                          ...
                          <div className="ctext-wrap">
                            ...
                            <Dropdown className="align-self-start message-box-drop">
                              ...
                              <Dropdown.Menu>
                                ...
                                <Dropdown.Item onClick={() => deleteChat(item)}>
