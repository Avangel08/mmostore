            ...
            <div className="col-auto ms-sm-auto">
              <div className="avatar-group" id="newMembar">
                {(headData || []).map((item: any, key: any) => (
                  <Link href="#" className="avatar-group-item material-shadow" data-bs-toggle="tooltip" key={key} data-bs-trigger="hover" data-bs-placement="top" aria-label={item.name} data-bs-original-title={item.name}>
                    <img src={item.picture} alt="" className="rounded-circle avatar-xs" />
                  </Link>
                ))}
                <Link href="#addmemberModal" data-bs-toggle="modal" className="avatar-group-item material-shadow" >
                                                ...
                                                <div className="flex-shrink-0">
                                                  <div className="avatar-group">
                                                    {card.userImages.map((picturedata: any, idx: any) => (
                                                      <Link href="#" className="avatar-group-item material-shadow" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Alexis" key={idx}>
