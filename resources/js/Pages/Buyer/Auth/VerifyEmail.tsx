                            ...
                            <Row className="justify-content-center">
                                <Col md={8} lg={6} xl={5}>
                                    ...
                                    <div className="mt-4 text-center">
                                        <p className="mb-0">Didn't receive a code ? <Link href={route('buyer.password.reset')} className="fw-semibold text-primary text-decoration-underline">Resend</Link> </p>
                                    </div>
                                </Col>
                            </Row>
                        </Container>
